  ...
  return (
    <main className="flex flex-col text-center items-center justify-center min-h-[calc(100vh-120px)] px-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center animate-slide opacity-0">
        <Link href={"/tickets/new"} className="bg-blue-600 text-white px-6 py-3 rounded-md shadow hover:bg-blue-700
         transition" >
        Submit a Ticket</Link>
        <Link href={"/tickets/new"} className="bg-blue-100 text-gray-700 px-6 py-3 rounded-md shadow hover:bg-blue-200
         transition" >
        View Tickets</Link>
      </div>
    </main>
